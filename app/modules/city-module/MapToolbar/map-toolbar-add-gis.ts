...
@Component({
    selector: "stm-map-toolbar-addGIS",
    templateUrl: "./app/modules/city-module/MapToolbar/templates/addGIS.html"
})

export class STMMapToolbarAddGIS implements OnInit {
    ...
    ngOnInit(): void {
        this.inputFile = document.getElementById("inputFileGIS") as HTMLInputElement;
    }
